...
project_palettes <- list(
  ...
  region_colours = setNames(c("#2dc4cc", "#e0690d", "#7570B3", "#E7298A", "#66A61E", "#E6AB02", "#66A61E", "#E6AB02"), c("Adenomyosis", "Basalis", "Functionalis", "LE", "Myometrium near adeno", "Myometrium near endo", "Myometrium_near_adeno", "Myometrium_near_endo")),
  #segment_colours <- c("#FF8E73", "#2B6FAB", "#A6EF4B", "#FFA8FF")
  segment_colours = setNames(c("#fcb02b", "#0F5A94", "#BEC100", "#b52658"), c("CD31", "CD45", "PanCK", "Stroma")),
